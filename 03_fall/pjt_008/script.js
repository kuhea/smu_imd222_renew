...
var boxA = Bodies.rectangle(500,200, 80, 80,{isStatic:true});
var boxB = Bodies.rectangle(500,300, 80, 80);
var boxC = Bodies.rectangle(500,400, 80, 80);
var boxD = Bodies.circle(30, 75, 3);
var boxE = Bodies.circle(20, 30, 10);
...
Composite.add(engine.world, [ground1,ground2,boxA,boxB,boxC,AtoB,BtoC,boxD,boxE]);
